document.addEventListener("DOMContentLoaded", () => {
    ...
    // 4. CATEGORY FILTERING (GRID SAFE & EMPTY STATE)
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            if (emptyMessage) {
                if (visibleCount === 0) {
                    setTimeout(() => { emptyMessage.classList.remove("d-none"); }, 300);
                } else {
    ...
    if(textElement) {
        ...
        function typeEffect() {
            ...
            if (!isDeleting && charIndex === currentWord.length) {
                ...
                isDeleting = false; wordIndex = (wordIndex + 1) % words.length; typingSpeed = 500;
            }
    ...
    // 7. EXECUTIVE PARTICLE NETWORK ENGINE (HERO ONLY)
